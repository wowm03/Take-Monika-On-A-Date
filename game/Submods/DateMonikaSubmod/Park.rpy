...
label park:
    ...
    if renpy.random.randint(1, 3) == 1:
        ...
        menu:
            "\"H.. how did you know?\"":
                                       m 5eua_tmoad "Hehe! I just did! After all, there's 75 percent chance you'd have done that, making you belong to the group to immediately try to lick their elbow after hearing that."
...
label fav_pet_choice:
    menu:
        ...
        "\"Turtles.\"":
                      m 1d_tmoad "Ohh~ "
                      extend 3hub_tmoad "turtles! I've always found them interesting!"
    ...
    menu:
        ...
        "\"Let's chat a bit.\"":
                               ...
                               if renpy.random.randint(1, 3) == 1:
                                   ...
                                   m 2eud_tmoad "The reason I'm mentioning this, is because I noticed the guy who makes this submod also plans on creating a Tetris minigame for me.{w=1} Similar to Just Yuri."
